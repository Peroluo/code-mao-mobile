...
// Build a entry less file to dist/lbk-common-components.less
var fs = require('fs');
var path = require('path');

if(fs.existsSync(path.join(__dirname,'../dist'))) {
  console.log('Building a entry less file to dist/lbk-common-components.less');
...
// Build components in one file: lib/style/components.less
  fs.readdir(componentsPath, function (err, files) {
    ...
    fs.writeFileSync(
      path.join(process.cwd(), 'dist', 'lbk-common-components.less'),
