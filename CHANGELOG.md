...
`lbk-common-components` 严格遵循 [Semantic Versioning 2.0.0](http://semver.org/lang/zh-CN/) 语义化版本规范。
...
注意：根据之前的 [2.1.x 最后版本计划](https://github.com/ant-design/ant-design-mobile/issues/2556)，我们已经分离 react native 组件代码到单独的 [ant-design-mobile-rn](https://github.com/ant-design/ant-design-mobile-rn) 仓库，并且已经发布了 `lbk-common-components-rn` 包。如果使用 react native 组件，请这样修改 `package.json` 文件：

```diff
  ...
  "dependencies": {
-   "lbk-common-components": "^2.1.11",
+   "lbk-common-components-rn": "^2.2.0",
    "react": "16.3.1",
    ...
  },
  ...
...
- **Enhancement**
  ...
  - 📝 RN: 提示将拆分出单独的 `lbk-common-components-rn` 包 ([#2556](https://github.com/ant-design/ant-design-mobile/issues/2556))
...
- **Notice**
  ...
  - lbk-common-components `Icon` 所依赖的开源 webpack loader `svg-sprite-loader` 最近从 `0.3` 直接升级到了 `2.0`, 其配置方案发生了 break change，但由于此 loader 的版本由用户代码控制，而功能被 lbk-common-components 和用户代码所共同依赖， lbk-common-components 团队只能选择在 `2.0` 对其进行升级，请各位用户在 `lbk-common-components@1.x` 期间暂时不要升级 `svg-sprite-loader`，在项目里仍然使用 `svg-sprite-loader@0.3.x` 即可。[#1283](https://github.com/ant-design/ant-design-mobile/issues/1283)
  - 新增 warning，提醒用户 lbk-common-components `2.0` 将会废弃 `Table`。[e1009015e](https://github.com/ant-design/ant-design-mobile/commit/e1009015e0c0740045995555831d1598a99c629f)
...
- **Improve && Enhancement**
  ...
  - [官方 Demo 集合](https://github.com/ant-design/lbk-common-components-samples) 新增 roadhog 示例
...
* **Improve & Enhancement**
  ...
  - 官方 demo 更新 [lbk-common-components-samples](https://github.com/ant-design/lbk-common-components-samples)
